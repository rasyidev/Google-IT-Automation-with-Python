...
class Sarung(Clothing):
  super()
  material = "Sutra Samarinda"

wadimor = Sarung("Wadimor")
polo = shirt("Polo")
...
print(current_stock)
print("polo stock: ", polo.stock)
print("sweetpants stock: ", sweatpants.stock)
print("wadimor stock: ", wadimor.stock)